...
export const closingSlides: Slide[] = [
  ...
  // End
  {
    ...
    blocks: [
      ...
      { type: 'paragraph', props: { html: 'AI是你的助理，不是你的替代。讓它處理瑣事，你去做最有價值的事。', class: 'sub', style: { fontSize: '26px' } } },
      { type: 'html', props: { content: '<div style="margin-top:48px;display:flex;gap:32px;opacity:.5;font-size:16px;justify-content:center;"><span>課後問卷</span><span>|</span><span>YouTube頻道</span><span>|</span><span>Prompt模板</span></div>' } },
    ],
  },
]
